...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, enemy_type, cfg, resource_loader):
        ...
        self.images = [
            resource_loader.images['game']['enemy_yellow'], resource_loader.images['game']['enemy_red'], 
            resource_loader.images['game']['enemy_pink'], resource_loader.images['game']['enemy_blue']
        ]
