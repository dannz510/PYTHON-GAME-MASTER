...
class GameLevels():
    ...
    def restart(self):
        self.level_pointer = 1
        self.start()
    '''Game level switching interface'''
    def switchlevelinterface(self):
        ...
        dannz_label = Label(self.screen, self.screen_size[0] - 270, self.screen_size[1] - 20, 300, 100)
        dannz_label.addtext('DANNZ', 60, self.cfg.FONT_PATHS_DICT_NOINIT['arfmoochikncheez'], (113, 125, 126))
        ...
        while True:
            ...
            for component in [replay_btn, next_btn, quit_btn, level_switch_label, score_label, dannz_label]:
                component.draw()
        ...
        while True:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if replay_btn.selected(): replay_btn.action()
                    if quit_btn.selected(): quit_btn.action()
            for component in [replay_btn, quit_btn, failure_label, score_label, dannz_label]:
                component.draw()
            pygame.display.update()
            clock.tick(self.cfg.FPS)
        ...
        while True:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if quit_btn.selected(): quit_btn.action()
            for component in [replay_btn, resume_btn, quit_btn, pause_label, dannz_label]:
                component.draw()
            pygame.display.update()
            clock.tick(self.cfg.FPS)
    '''Start the game'''
    def start(self):
        ...
        while True:
            ...
            # --Judge whether the pig hits the wooden stake
                ...
                for j in range(len(blocks)):
                    ...
                    if is_collision:
                        ...
                        if abs(block_magnitude_2 - block_magnitude_1) > 2:
                            ...
                            pigs[i].setdead()
            # --Judge whether the bird hits the wooden stake
            ...
            for i in range(len(pigs)):
                ...
                pigs[i].draw()
            # --Judge whether the bird hits the pig or the wall
            for i in range(len(birds)):
                ...
                birds[i].draw()
            # --Judge whether the wooden pile hits the wooden pile or the wooden pile hits the wall
            ...
            if self.still(birds + pigs + blocks):
                ...
                pigs_to_remove = []
                blocks_to_remove = []
    '''Load the game map of the current level'''
